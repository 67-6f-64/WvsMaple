...
namespace Assembine
{
    ...
    {
        private static readonly string _monoPointix =
            "Mono.Pointix, Version=2.0.0.0, Culture=neutral, PublicKeyToken=0738eb9f132ed756";
        ...
        static MemoryMappedFile()
        {
            ...
            if (_isLinux) Assembly.Load(_monoPointix);
        }
        ...
        {
            Type openFlags = Type.GetType(Assembly.CreateQualifiedName(_monoPointix, "Mono.Unix.Native.OpenFlags"));
            MethodInfo mi =
                Type.GetType(Assembly.CreateQualifiedName(_monoPointix, "Mono.Unix.Native.Syscall"))
        ...
        {
            Type mmapProts = Type.GetType(Assembly.CreateQualifiedName(_monoPointix, "Mono.Unix.Native.MmapProts"));
            Type mmapFlags = Type.GetType(Assembly.CreateQualifiedName(_monoPointix, "Mono.Unix.Native.MmapFlags"));
            MethodInfo mi =
                Type.GetType(Assembly.CreateQualifiedName(_monoPointix, "Mono.Unix.Native.Syscall"))
                    .GetMethod("mmap",
