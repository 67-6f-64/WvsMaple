...
namespace Common.Net
{
    public class Session
    {
                ...
                if (_bufferpos == _bufferlen)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            packet = new Packet(_buffer, true);
        ...
        public virtual void Send(Packet outPacket)
        {
            SendData(outPacket.ToArray());
        }
        ...
        public void SendHandshake(ushort pVersion, string pPatchLocation, byte pLocale)
        {
            ...
            {
                p.WriteUShort(pVersion);
                p.WriteString(pPatchLocation);
                p.WriteBytes(_decryptIV);
                p.WriteBytes(_encryptIV);
                p.WriteByte(pLocale);
        ...
        {
            _rijndaelAES.Key = GMSKeys.GetBetaKey();
